...
public class ApplicationConfig {
    ...
    private final ISongService songService = new SongServiceImpl(songRepository, userRepository);
    ...
    public CommandInvoker getCommandInvoker(){
        ...
        commandInvoker.register("MODIFY-PLAYLIST", ModifyPlaylistAddSongCommand);
        commandInvoker.register("MODIFY-PLAYLIST", modifyPlaylistDeleteSongCommand);
